...
if __name__ == '__main__':
    ...
    parser.add_argument('-data_dir', default="./dataset/crack_segmentation_dataset/train/",type=str, help='input dataset directory')
    parser.add_argument('-model_dir',default="./output/", type=str, help='output dataset directory')
    parser.add_argument('-model_type',default="vgg16", type=str, required=False, choices=['vgg16', 'resnet101', 'resnet34'])
    ...
    # add gpu
    os.environ["CUDA_VISIBLE_DEVICES"] = "1"  # ecide GPU
