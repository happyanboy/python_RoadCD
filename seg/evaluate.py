...
if __name__ == '__main__':
    ...
    arg = parser.add_argument  # default="./dataset/crack_segmentation_dataset/test/masks/"
    # "./dataset/crack_segmentation_dataset/test/images/"
    arg('-ground_truth_dir',default="./dataset/crack_segmentation_dataset/test/masks/", help='path where ground truth images are located') # del required=True
    arg('-pred_dir',default="./dataset/crack_segmentation_dataset/test/images/",type=str,  help='path with predictions')
